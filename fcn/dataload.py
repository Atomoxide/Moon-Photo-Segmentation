...
train_filenames = [train_dir + filename for filename in train_list_dir[0:6400]]

train_label_filenames = [train_label_dir +
                         filename for filename in train_label_list_dir[0:6400]]

# for i in range(len(train_filenames)):
#     print ((train_filenames[i],train_label_filenames[i]))
#     print('\n')
...
#        gt_image = np.concatenate((gt_bg, gt_g, gt_br,gt_sr), axis=2)
        gt_image = np.stack((gt_sr, gt_g, gt_br,gt_bg), axis=2)
